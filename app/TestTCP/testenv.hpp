...
protected:
	...
	virtual void SetUp()
	{
		...
		uint8_t mac1[6] = {0xAB,0xAB,0xAB,0xAB,0xAB,0xAB};
		uint8_t mac1_2[6] = {0xBA,0xBA,0xBA,0xBA,0xBA,0xBA};
		uint8_t mac2[6] = {0xEF,0xEF,0xEF,0xEF,0xEF,0xEF};
		uint8_t mac2_2[6] = {0xFE,0xFE,0xFE,0xFE,0xFE,0xFE};
...
protected:
	...
	virtual void SetUp()
	{
		...
		uint8_t server_mac[6] = {0xAB,0xAB,0xAB,0xAB,0xAB,0xAB};
