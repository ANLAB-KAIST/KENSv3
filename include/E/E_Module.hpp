...
protected:
   ...
   * If you want to handle Message, override this function with your own
   * handler.
   *
   ...
   * @param message Message you received. This message is allocated by other
   * module, so DO NOT DEALLOCATE THE GIVEN MESSAGE (even it is your self
   * message).
  ...
  /**
   * @brief This is a callback function called by the System.
   * This function is automatically called after your message is processed by
   * the destination module. If you want to handle Message, override this
   * function with your own handler. YOU MUST DEALLOCATE EVERY SUCCESSFUL
   * MESSAGE YOU ALLOCATED JUST HERE. INSTANT RESPONSE messages(return value of
   * messageReceived) are also deallocated here. SELF messages are also
   * deallocated here.
   *
  ...
  /**
   * @brief This is a callback function called by the System.
   * This function is automatically called when the message is cancelled before
   * it is processed. This function is called AT THE TIME WHEN THE MESSAGE WAS
   * SUPPOSED TO BE SENT. If you want to handle Message, override this function
   * with your own handler. YOU MUST DEALLOCATE EVERY CANCELLED MESSAGE YOU
   * ALLOCATED JUST HERE.
   *
   * @param to Destination of the Message(including [this]).
   * If you sent a message to yourself, this parameter would be [this].
   ...
   * @note Using default implementation is forbidden.
   * If you use send any message, you must override this function with your own
   * implementation. This function is similar to messageFinished except its
   * response message is always null.
   *
   * @see messageFinished
   */
   ...
   *
   * @param messageID Unique ID that represents the target Message to be
   * cancelled.
