...
public:
  AffinityTask(Affinity affinity, Computer *computer, Time period,
  ...
  BFS(const TaskSet &taskSet, const GraphNode &start, const GraphNode &target,
      const Affinity &excludeID, const TaskSet &excludeTask);
  static void
  DFS(std::list<std::list<GraphNode>> &saveAt,
  ...
  static std::list<std::list<GraphNode>> allPath(const TaskSet &taskSet,
  ...
  static TaskSet generateTaskSet(Computer *computer, Size numTask,
                                 ...
                                 Time minPeriod, Time maxPeriod,
                                 RandomDistribution *periodDistribution,
                                 Real targetUtilization,
                                 RandomDistribution *utilDistribution);
